...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th6 18, 2020 lúc 07:05 PM
...
(1, 'admin', 'c4ca4238a0b923820dcc509a6f75849b', 'Tống Việt Huỳnh Mai', 'tvh.mai.us@gmail.com', '1999-12-27', '2019-11-22 20:19:30', 1, 'Q1', '0386552312'),
...
ALTER TABLE `detailorder`
  ...
  ADD CONSTRAINT `detailorder_ibfk_2` FOREIGN KEY (`idProduct`) REFERENCES `product` (`id`) ON DELETE CASCADE;
